...
const PabujiWeddinginfo = (props: Props) => {
  ...
  return (
    <>
      ...
      <motion.button
        className="absolute top-[54%] left-[16%] cursor-pointer z-[999] rounded-full w-4 h-4 bg-emrald-700 hover:bg-emerald-700 "
        // onClick={handleStartAnimation}
        whileHover={{ scale: 1.2 }}
        whileTap={{ scale: 0.9 }}
      >
        <motion.span
          className="absolute top-0 left-0 w-full h-full rounded-full bg-pink-500 opacity-50"
