...
const Pabujiinfo = (props: Props) => {
  ...
  return (
    <>
      ...
      <motion.button
        className="absolute top-[42%] left-[27%] cursor-pointer z-[999] rounded-full w-4 h-4 bg-emrald-700 hover:bg-emerald-700 "
        // onClick={handleStartAnimation}
