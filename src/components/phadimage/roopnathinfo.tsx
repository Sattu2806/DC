...
const RoofNathinfo = (props: Props) => {
  ...
  return (
    <>
      ...
      <motion.button
        className="absolute top-[30%] left-[97%] cursor-pointer z-[999] rounded-full w-4 h-4 bg-rose-500  "
        // onClick={handleStartAnimation}
        whileHover={{ scale: 1.2 }}
        whileTap={{ scale: 0.9 }}
      >
        <motion.span
          className="absolute top-0 left-0 w-full h-full rounded-full bg-rose-300 opacity-50"
