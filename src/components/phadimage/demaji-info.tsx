    ...
    <>
      ...
      <Dialog open={showAnimations} onOpenChange={setShowAnimations}>
        <DialogContent className="sm:max-w-lg">
          <DialogHeader>
            <DialogTitle>Dhema Ji with Opium</DialogTitle>
            <DialogDescription>
      ...
      <motion.button
        className="absolute top-[80%] left-[27%] cursor-pointer z-[999] rounded-full w-4 h-4 bg-violet-700 hover:bg-purple-700 "
